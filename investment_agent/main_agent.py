...
def chat_with_agent(message):
    ...
    Provide most professional, data-driven analysis including:
    ...
    Proactively alert me to significant price movements, volatility spikes, trend reversals, or material news events, and clearly explain the investment impact in precise."
    )
